...
Access premium Elementor template kits and stock photos without an Envato Elements subscription.
...
= 1.1.1 =
Update includes a fix for the GitHub repository URL in the update checker.

= 1.1.0 =
Update includes a new plugin update checker for more reliable updates.

= 1.0.5 =
Update includes improved update information handling and cleanup after successful updates.

= 1.0.4 =
Update includes improved update information handling and cleanup after successful updates.

= 1.0.3 =
Update includes fixes for update notification system and improved version checking.

= 1.0.2 =
Update includes fixes for GitHub updater folder handling and improved update process.
